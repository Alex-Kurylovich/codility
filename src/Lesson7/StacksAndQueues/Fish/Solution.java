...
Lesson7.StacksAndQueues.Fish number P is represented by A[P] and B[P]. Array A contains the sizes of the fish.
...
Lesson7.StacksAndQueues.Fish number 1 meets fish number 2 and eats it, then it meets fish number 3 and eats it too.
...
class Solution {
    ...
    public static void main(String[] args) {
 		int result = new Solution().solution(new int[] {4, 3, 2, 1, 5}, new int[] {0, 1, 0, 0, 0});
